(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('invariant'), require('@react-google-maps/marker-clusterer'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'invariant', '@react-google-maps/marker-clusterer', 'react-dom'], factory) :
  (global = global || self, factory(global.reactGoogleMapsApi = {}, global.React, global.invariant, global.markerClusterer, global.reactDom));
}(this, function (exports, React, invariant, markerClusterer, reactDom) { 'use strict';
  ...
  var applyUpdaterToNextProps = function applyUpdaterToNextProps(updaterMap, prevProps, nextProps, // eslint-disable-next-line @getify/proper-arrows/params
  instance) {
    var map = {};
  ...
  var preventGoogleFonts = function preventGoogleFonts() {
    console.log('preventGoogleFonts run'); // we override these methods only for one particular head element
  ...
  function (_React$PureComponent) {
    ...
    function LoadScript() {
      ...
      _this.injectScript = function () {
        ...
        !(typeof _this.props.id === 'string') ? invariant(false, 'LoadScript requires "id" prop to be a string') : void 0;
  ...
  function (_React$PureComponent) {
    ...
    function DrawingManager(props) {
      ...
      !google.maps.drawing ? invariant(false, 'Did you include "libraries=drawing" in the URL?') : void 0;
      return _this;
    }
  ...
  function (_React$PureComponent) {
    ...
    _proto.render = function render() {
      return this.containerElement !== null ? reactDom.createPortal(React.Children.only(this.props.children), this.containerElement) : React.createElement(React.Fragment, null);
    };
  ...
  function (_React$PureComponent) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      !google.maps.visualization ? invariant(false, 'Did you include "visualization" in the libraries array prop in <LoadScript />?') : void 0;
      !this.props.data ? invariant(false, "data property is required in HeatmapLayer") : void 0;
  ...
  function (_React$PureComponent) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      !google.maps.places ? invariant(false, 'You need to provide libraries={["places"]} prop to <LoadScript /> component') : void 0;
  ...
  function (_React$PureComponent) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      !google.maps.places ? invariant(false, 'You need to provide libraries={["places"]} prop to <LoadScript /> component') : void 0; // TODO: why is this possibly null
      // @ts-ignore
